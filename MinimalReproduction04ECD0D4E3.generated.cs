...
namespace MinimalRepro
{
	...
	public partial class Blort
	{
		...
		/// </summary>
		[Association(ThisKey = nameof(X) + "," + nameof(X) + "," + nameof(X), OtherKey = nameof(Foo.BlortX) + "," + nameof(X) + "," + nameof(X))]
	...
	public static partial class ExtensionMethods
	{
		...
		[Sql.Function("[ExampleFunction]", ServerSideOnly = true)]
	...
	public partial class Foo
	{
		...
		/// FK_Foo_Blort
		/// </summary>
		[Association(CanBeNull = false, ThisKey = nameof(BlortX) + "," + nameof(BlortX) + "," + nameof(BlortX), OtherKey = nameof(MinimalRepro.Blort.X) + "," + nameof(BlortX) + "," + nameof(BlortX))]
